...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <customApplicationComponents>
        ...
        <customApplicationComponent>Queue_Dashboard</customApplicationComponent>
    </customApplicationComponents>
    <defaultLandingTab>standard-home</defaultLandingTab>
    <detailPageRefreshMethod>autoRefresh</detailPageRefreshMethod>
    <domainWhitelist>
        <domain>*.visual.force.com</domain>
        <domain>*.cs31.visual.force.com</domain>
        <domain>www.salesforce.com</domain>
        <domain>www.yahoo.com</domain>
        <domain>c.cs31.visual.force.com</domain>
        <domain>force.com</domain>
        <domain>www.google.co.in</domain>
        <domain>*.force.com</domain>
    </domainWhitelist>
    ...
    <footerColor>#515F6b</footerColor>
    ...
    <label>Integrated Collections Management</label>
    <listPlacement>
        <location>full</location>
    </listPlacement>
    <listRefreshMethod>refreshList</listRefreshMethod>
    <logo>Pepper_Documents/Pepper_Logo.png</logo>
